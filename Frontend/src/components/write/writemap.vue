                ...
                <b-row>
                    <b-col>
                        <div>
                            ...
                            <b-form-input class="mt-1" v-model="aptName" placeholder="아파트"></b-form-input>
                        </div>
                    </b-col>
                </b-row>
                
                <div id="map" style="width:100%;height:250px" class="mt-1"></div>
            </b-container>
        </div>
    </div>
</template>
    ...
    methods: {
        ...
        addMarker(aptInfo){
            ...
            kakao.maps.event.addListener(marker, 'click', function(){
                //dongCode랑 aptCode를 변수로 저장해서 보내줘야함
                that.aptName = aptInfo.aptName;
                that.$emit('dongCode', aptInfo.dongCode);
                that.$emit('aptCode', aptInfo.aptCode);
